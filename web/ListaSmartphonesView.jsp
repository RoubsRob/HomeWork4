<%-- 
    Document   : ListaSmartphonesView
    Created on : 18/12/2017, 14:29:15
    Author     : Roberta
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ArrayList<Produtos> resultado = (ArrayList) request.getAttribute("meusSmart");
