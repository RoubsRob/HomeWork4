...
@Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Produtos> meusProdutos = produtos_dao.ListarSmartphones();
        request.setAttribute("meusSmart", meusProdutos);
        RequestDispatcher rd = request.getRequestDispatcher("ListaSmartphonesView.jsp");
