 ...
 * @author Roberta
 */
@WebServlet(name = "IncluirClientes", urlPatterns = {"/IncluirClientes"})
public class IncluirClientes extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("erro_id", "");
                ...
                Clientes clientes = new Clientes(endereco,bairro,cep,estado,referencia,cpf,identidade,
